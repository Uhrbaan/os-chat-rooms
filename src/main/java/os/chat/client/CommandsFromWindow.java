 ...
 * These methods will be called from the chat GUI to operate your client. This file must not be
 * modified.
 * 
 */
public interface CommandsFromWindow {
	...
	/**
	 * Ask to join the chat room. Does not leave existing chat rooms. //to do so we need to know
	 * only chatRoom name
	 * 
